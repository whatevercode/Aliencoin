...
uint256 hashGenesisBlock("0xe00ce50162ba662af2358cf560349a69d6088bd7d3afef324cc465e73240911c");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Aliencoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Aliencoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1051200); // Aliencoin: 1.0512mil blocks in ~1 year

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60 * 60;	// Aliencoin: 1 hour
static const int64 nTargetSpacing = 30;						// Aliencoin: 30 sec
static const int64 nInterval = nTargetTimespan / nTargetSpacing;
static const int64 nTargetTimespanRe = 60 * 60; // 60 Minutes
static const int64 nTargetSpacingRe = 30; // Aliencoin: 30 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
   ...
   if(fNewDifficultyProtocol) {
    ...
    // Aliencoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal aliencoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Aliencoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xaca835782db87e93a29329e375a65bcd03b169aacad2cd70036f07644dc234b3");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Girl, 3, dies after dental procedure";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389306346;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 244093;

        if (fTestNet)
        {
            block.nTime    = 1388887039;
            block.nNonce   = 1060473;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xe2d971c383496e2a5a0b149ada432888976e4a9772d9eb5e0dbe1052a3b1eaa9"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Aliencoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Aliencoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
